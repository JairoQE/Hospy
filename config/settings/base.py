...
# Verificación de identidad (Factiliza → ApiInti / RENIEC)
...
APIINTI_API_TOKEN = os.environ.get("APIINTI_API_TOKEN", "").strip()
APIINTI_BASE_URL = os.environ.get(
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        ...
        "## Convenciones\n"
        "- Prefijo base: `/api/v1/`\n"
        "- Documentación interoperabilidad: `/api/v1/sistema/protocolos/` (CIn-2-G), "
        "`/api/v1/sistema/interfaces/` (CIn-3-S)\n"
        "- Índice documentación: `/api/v1/sistema/`\n"
