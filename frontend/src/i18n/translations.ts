...
export const translations = {
  "es-PE": {
    ...
    home: {
      ...
      nearbyMapLabel: "Mapa de alrededores",
      nearbyMapLegend: "Leyenda del mapa",
      nearbyMapStay: "Hospedajes",
      priceAvgSuffix: "prom.",
    ...
    detail: {
      ...
      offerByEvent: "Oferta por evento",
      offerByEventNamed: "Oferta por evento: {name}",
      offerRoom: "N.º {n} · {type}",
      headerOfferBadge: "-{percent}% OFF",
      priceWas: "Antes {price}",
      offerApplied: "Con oferta",
      about: "Sobre este alojamiento",
      nearbyTitle: "Cerca de este alojamiento",
      nearbyLead:
        "Restaurantes, lugares turísticos y eventos en la zona para complementar tu estadía.",
      nearbyLoading: "Buscando opciones cercanas…",
      nearbyError: "No se pudieron cargar las opciones cercanas.",
      nearbyRestaurants: "Restaurantes",
      nearbyPlaces: "Lugares turísticos",
      nearbyEvents: "Eventos",
      nearbyRestaurantsEmpty: "No hay restaurantes cercanos por ahora.",
      nearbyPlacesEmpty: "No hay lugares turísticos cercanos por ahora.",
      nearbyEventsEmpty: "No hay eventos cercanos por ahora.",
      nearbySeeAll: "Ver todos",
      nearbyDistance: "Distancia",
      nearbyRating: "Valoración",
      nearbyEntry: "Entrada",
      nearbyInterest: "Interés",
      nearbyDate: "Fecha",
      nearbyViewOn: "Ver en {provider}",
  ...
  en: {
    ...
    home: {
      ...
      nearbyMapLabel: "Nearby map",
      nearbyMapLegend: "Map legend",
      nearbyMapStay: "Stays",
      priceAvgSuffix: "avg.",
    ...
    detail: {
      ...
      offerByEvent: "Event offer",
      offerByEventNamed: "Event offer: {name}",
      offerRoom: "No. {n} · {type}",
      headerOfferBadge: "-{percent}% OFF",
      priceWas: "Was {price}",
      offerApplied: "Offer applied",
      about: "About this stay",
      nearbyTitle: "Near this stay",
      nearbyLead:
        "Restaurants, tourist spots, and events nearby to complement your trip.",
      nearbyLoading: "Looking for nearby options…",
      nearbyError: "Could not load nearby options.",
      nearbyRestaurants: "Restaurants",
      nearbyPlaces: "Tourist spots",
      nearbyEvents: "Events",
      nearbyRestaurantsEmpty: "No nearby restaurants right now.",
      nearbyPlacesEmpty: "No nearby tourist spots right now.",
      nearbyEventsEmpty: "No nearby events right now.",
      nearbySeeAll: "See all",
      nearbyDistance: "Distance",
      nearbyRating: "Rating",
      nearbyEntry: "Entry",
      nearbyInterest: "Interest",
      nearbyDate: "Date",
      nearbyViewOn: "View on {provider}",
