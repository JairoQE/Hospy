...
ACTION_LABELS: dict[str, str] = {
    ...
    "accommodation.delete": "Eliminó hospedaje (soft delete)",
    "accommodation.soft_delete_admin": "Eliminó hospedaje (soft delete, admin)",
    "accommodation.restore": "Restauró hospedaje",
    ...
    "user.soft_delete": "Eliminó usuario (soft delete)",
    "user.restore": "Restauró usuario",
...
ACTION_SEVERITY: dict[str, str] = {
    ...
    "accommodation.soft_delete_admin": "high",
    "accommodation.restore": "high",
    "user.soft_delete": "high",
    "user.restore": "high",
